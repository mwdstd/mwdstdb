...
from mwdstdb.models import Survey, Station, BHA, Interval, Reference
...
async def correction_lv2(db: AsyncIOMotorDatabase, borehole_id: str, filter_visibility: bool = True):
    pipeline = [
